...
<script lang="ts">
import Wrapper from '$examples/rapier-simple/Wrapper.svelte'
</script>
...
&&&code_wrapper
@[code svelte|title=Wrapper.svelte](../../../../examples/rapier-simple/Wrapper.svelte)
@[code svelte|title=Scene.svelte](../../../../examples/rapier-simple/Scene.svelte)
&&&
